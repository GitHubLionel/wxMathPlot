...
MathPlotConfigDialog::MathPlotConfigDialog(wxWindow *parent, wxWindowID WXUNUSED(id))
{
  ...
  const wxString cbSeriesSymbolType_choices[] = {
	...
	Connect(ID_CHOICE16,wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(MathPlotConfigDialog::OncbFormatSelect));
	...
	Connect(ID_NOTEBOOK1,wxEVT_COMMAND_NOTEBOOK_PAGE_CHANGED, wxBookCtrlEventHandler(MathPlotConfigDialog::OnnbConfigPageChanged));
