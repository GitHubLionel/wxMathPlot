...
MathPlotConfigDialog::MathPlotConfigDialog(wxWindow* parent,wxWindowID WXUNUSED(id))
{
    ...
    StaticBox1 = new wxStaticBox(pTitle, ID_STATICBOX3, _T("Title "), wxPoint(0,0), wxSize(364,80), 0, _T("ID_STATICBOX3"));
    StaticText11 = new wxStaticText(pTitle, ID_STATICTEXT11, _T("Title :"), wxPoint(8,24), wxDefaultSize, 0, _T("ID_STATICTEXT11"));
    ...
    bFontTitle = new wxButton(pTitle, ID_BUTTON5, _T("Font"), wxPoint(292,20), wxSize(64,23), 0, wxDefaultValidator, _T("ID_BUTTON5"));
    bFontTitle->Disable();
    cbTitleVisible = new wxCheckBox(pTitle, ID_CHECKBOX8, _T("Visible"), wxPoint(8,56), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX8"));
    ...
    StaticBox2 = new wxStaticBox(pMargins, ID_STATICBOX5, _T("Margins "), wxPoint(0,0), wxSize(364,80), 0, _T("ID_STATICBOX5"));
    StaticText15 = new wxStaticText(pMargins, ID_STATICTEXT15, _T("Margins :"), wxPoint(8,24), wxDefaultSize, 0, _T("ID_STATICTEXT15"));
    edMarginTop = new wxTextCtrl(pMargins, ID_TEXTCTRL4, _T("50"), wxPoint(64,20), wxSize(40,23), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL4"));
    edMarginTop->SetToolTip(_T("Top"));
    edMarginBottom = new wxTextCtrl(pMargins, ID_TEXTCTRL5, _T("50"), wxPoint(112,20), wxSize(40,23), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL5"));
    edMarginBottom->SetToolTip(_T("Bottom"));
    edMarginLeft = new wxTextCtrl(pMargins, ID_TEXTCTRL6, _T("50"), wxPoint(160,20), wxSize(40,23), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL6"));
    edMarginLeft->SetToolTip(_T("Left"));
    edMarginRight = new wxTextCtrl(pMargins, ID_TEXTCTRL7, _T("50"), wxPoint(208,20), wxSize(40,23), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL7"));
    edMarginRight->SetToolTip(_T("Right"));
    bBGColor = new wxButton(pMargins, ID_BUTTON7, _T("bg color"), wxPoint(272,20), wxSize(72,23), 0, wxDefaultValidator, _T("ID_BUTTON7"));
    cbDrawBox = new wxCheckBox(pMargins, ID_CHECKBOX5, _T("Draw box"), wxPoint(8,56), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX5"));
    ...
    StaticBox4 = new wxStaticBox(pCoord, ID_STATICBOX8, _T("Coord "), wxPoint(0,0), wxSize(360,104), 0, _T("ID_STATICBOX8"));
    StaticText18 = new wxStaticText(pCoord, ID_STATICTEXT18, _T("Position :"), wxPoint(8,24), wxDefaultSize, 0, _T("ID_STATICTEXT18"));
    ...
    cbCoordVisible = new wxCheckBox(pCoord, ID_CHECKBOX10, _T("Visible"), wxPoint(8,56), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX10"));
    ...
    sbCoordBrush = new wxStaticBox(pCoordBrush, ID_STATICBOX10, _T("Brush "), wxPoint(0,0), wxSize(160,80), 0, _T("ID_STATICBOX10"));
    ...
    StaticText19 = new wxStaticText(Panel4, ID_STATICTEXT19, _T("Step :"), wxPoint(208,264), wxDefaultSize, 0, _T("ID_STATICTEXT19"));
    ...
    bDelSeries->Disable();
    nbConfig->AddPage(Panel3, _T("General"), false);
    nbConfig->AddPage(Panel2, _T("Legend"), false);
    nbConfig->AddPage(Panel1, _T("Axis"), false);
